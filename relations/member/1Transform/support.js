...
function shouldProcessMemberHTML(htmlFile, jsonfile) {
...
//mTimes = file modification times = {memberId, mtime}
//uTimes = database update times = {memberId, updateDTTM}
function shouldProcessMemberJSON(jsonfile) {}
